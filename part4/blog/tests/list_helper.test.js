...
describe('favorite blog', () => {
  ...
  test('return the blog with most likes from a list of blogs', () => {
...
describe('most blogs author', () => {
  ...
  test('return author with the most blogs from a list of blogs', () => {
...
describe('most likes author', () => {
  ...
  test('when list has only one blog, return the author with the likes', () => {
  ...
  test('return author with the most likes from a list of blogs', () => {
